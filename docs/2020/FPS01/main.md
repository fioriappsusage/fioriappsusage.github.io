...
All usage records are available for download in an [Excel format](https://fioritracker.org/features/usage-report/#records-export). Downloaded data can be further analyzed or visualized in a separate application.
